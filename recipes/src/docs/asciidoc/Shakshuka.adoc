...
Taken from the internet and modified to my liking. This dish is great because it makes enough sauce to do the egg thing twice and after than it is a good dipping sauce for grilled cheese.
...
1. Tranfer to a broiler for 3-4 minutes until the egg white is cooked.
